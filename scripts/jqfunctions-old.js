...
$(".tcls").remove();
  $.get("http://localhost/vvv_exam/jqfunctions/get_topics/",{subj_id:subj},function(response){
                   if(response){
                        $(".tcls").remove();
...
function updt_ques(qid, col, val){
  $.get("http://localhost/vvv_exam/jqfunctions/updt_ques/",{qid:qid, col:col, val:val},function(response){
                    if(response){
                      //alert(response);
                    }
                });
...
$(".tcls").remove();
  $.get("http://localhost/vvv_exam/jqfunctions/get_cbatches/",{subj_id:subj},function(response){
                   if(response){
                        $(".tcls").remove();
...
$(".qcls").remove();
  $.get("http://localhost/vvv_exam/jqfunctions/get_qbranches/",{qid:qid},function(response){
                   if(response){
                        $(".qcls").remove();
...
$(".qcls2").remove();
  $.get("http://localhost/vvv_exam/jqfunctions/get_qbranches2/",{qid:qid},function(response){
                   if(response){
                        $(".qcls2").remove();
...
$(".tcls").remove();
  $.get("http://localhost/vvv_exam/jqfunctions/get_cprojects/",{pcid:pcid},function(response){
                   if(response){
                        $(".pcls").remove();
